...
public final class ProcessedBone {
  ...
  @Nullable private final ProcessedBone parent;
  ...
  public boolean equals(Object obj) {
    ...
    return this.index == other.index && Objects.equals(this.name, other.name);
  }
  ...
  public @NotNull String toString() {
    return String.format(
        "Bone[%d: %s, children=%d, depth=%d]", index, name, children.size(), getDepth());
  }
