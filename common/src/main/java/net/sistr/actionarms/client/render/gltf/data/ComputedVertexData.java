...
public class ComputedVertexData {
    ...
    public boolean hasNormals() {
        return finalNormals != null;
    }

    public boolean hasUvCoordinates() {
        return uvCoordinates != null;
    }
    ...
    public float[] getFinalPositionsReadOnly() {
        return finalPositions;
    }

    public float[] getFinalNormalsReadOnly() {
        return finalNormals;
    }

    public float[] getUvCoordinatesReadOnly() {
