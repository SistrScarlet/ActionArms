...
public class GltfRenderLayer {
  ...
  private static final Function<Identifier, RenderLayer> ENTITY_CUTOUT_TRIANGLE =
      Util.memoize(
          texture -> {
            var params =
  ...
  private static final Function<Identifier, RenderLayer> ENTITY_CUTOUT_NO_CULL_TRIANGLE =
      Util.memoize(
          texture -> {
            var params =
                RenderLayer.MultiPhaseParameters.builder()
                    ...
                    .build(true);
            return RenderLayer.of(
                nameOf("entity_cutout_no_cull_triangle"),
                VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL,
                VertexFormat.DrawMode.TRIANGLES,
                256,
                true,
  ...
  private static final BiFunction<Identifier, Boolean, RenderLayer> ENTITY_TRANSLUCENT_TRIANGLE =
      Util.memoize(
          (texture, affectsOutline) -> {
            ...
            return RenderLayer.of(
                nameOf("entity_translucent_triangle"),
                VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL,
                VertexFormat.DrawMode.TRIANGLES,
                256,
                true,
  ...
  public static RenderLayer getEntityTranslucentTriangle(
      Identifier identifier, boolean affectsOutline) {
