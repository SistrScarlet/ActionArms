    ...
    return CompletableFuture.supplyAsync(
            () -> {
              ...
              var metadataResources =
                  manager.findResources("gltf/models", id -> id.getPath().endsWith(".json"));
              ...
              for (var entry : metadataResources.entrySet()) {
                ...
                try (var reader =
                  ...
                  String metadataId =
                      path.substring("gltf/models/".length(), path.length() - ".json".length());
                  ...
                  ActionArms.LOGGER.debug(
                      "Loaded glTF metadata: {} -> {}", metadataKey, parsedMetadata.modelPath());
