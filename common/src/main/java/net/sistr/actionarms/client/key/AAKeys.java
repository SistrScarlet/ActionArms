...
public class AAKeys {
  ...
  public static final KeyBinding KEY_FIRE =
      new KeyBinding(
          "key.actionarms.fire", InputUtil.Type.MOUSE, GLFW.GLFW_MOUSE_BUTTON_LEFT, KEY_CATEGORY);
  public static final KeyBinding KEY_AIM =
      new KeyBinding(
          "key.actionarms.aim", InputUtil.Type.MOUSE, GLFW.GLFW_MOUSE_BUTTON_RIGHT, KEY_CATEGORY);
  public static final KeyBinding KEY_RELOAD =
      new KeyBinding("key.actionarms.reload", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_R, KEY_CATEGORY);
