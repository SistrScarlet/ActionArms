...
public class GltfMeshRenderer {
    ...
    private void applyHideBones(
            RenderingContext context, ProcessedSkin skin, float[] animationData) {
    ...
    private void renderVertex(
        ...
        if (mesh.hasSkinning() && boneMatrices != null) {
            ...
            Vector3f normalResult =
                    applySkinningToNormal(mesh, vertexIndex, boneMatrices, nx, ny, nz);
            x = skinResult.x;
            y = skinResult.y;
            z = skinResult.z;
            nx = normalResult.x;
