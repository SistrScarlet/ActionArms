...
/** アクセサの内容を一意に識別するためのシグネチャ 同じデータを持つアクセサは同じシグネチャを持ち、キャッシュで共有される */
public class AccessorSignature {
  ...
  public String toString() {
    return String.format(
        "AccessorSignature[bufferView=%d, offset=%d, type=%s(%d), count=%d, normalized=%s]",
