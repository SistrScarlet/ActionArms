...
public class ProcessedGltfModel {
    ...
    private final Map<String, ProcessedAnimation> animations;
    ...
    public ProcessedGltfModel(String name, List<ProcessedMesh> meshes, List<ProcessedSkin> skins,
        ...
        this.animations = animations.stream()
                .collect(Collectors.toMap(ProcessedAnimation::getName, a -> a));
    ...
    public GltfModel getOriginalGltfModel() {
        return originalGltfModel;
    }

    // メッシュ関連
    public List<ProcessedMesh> getMeshes() {
        return new ArrayList<>(meshes);
    }

    public void addMesh(ProcessedMesh mesh) {
        meshes.add(mesh);
    }
    ...
    // スキン関連
    public List<ProcessedSkin> getSkins() {
        return new ArrayList<>(skins);
    }

    public void addSkin(ProcessedSkin skin) {
        skins.add(skin);
    }
    ...
    // アニメーション関連
    public Optional<ProcessedAnimation> getAnimation(String name) {
    ...
    // モーフターゲット関連
    public int getMaxMorphTargetCount() {
        return maxMorphTargetCount;
    }
