...
/** 変換済みglTFモデルデータの統合管理recordクラス（マテリアル対応・不変設計） ロード時に一度構築された後は変更されない設計 */
public record ProcessedGltfModel(
    ...
    public ProcessedGltfModel(
            ...
            List<ProcessedSkin> skins,
            List<ProcessedMaterial> materials,
            List<ProcessedAnimation> animationList,
        ...
        this(
                ...
                materials,
                animationList != null
                        ? animationList.stream()
                                .collect(Collectors.toMap(ProcessedAnimation::name, a -> a))
    ...
    public static class Builder {
        ...
        public ProcessedGltfModel build() {
            return new ProcessedGltfModel(
                    name, meshes, skins, materials, animations, originalGltfModel);
        }
    }
