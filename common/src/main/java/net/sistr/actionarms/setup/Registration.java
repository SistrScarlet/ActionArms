...
public class Registration {
  private static final DeferredRegister<Item> ITEMS =
      DeferredRegister.create(ActionArms.MOD_ID, RegistryKeys.ITEM);
  private static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
      DeferredRegister.create(ActionArms.MOD_ID, RegistryKeys.ENTITY_TYPE);
  private static final DeferredRegister<SoundEvent> SOUND_EVENTS =
      DeferredRegister.create(ActionArms.MOD_ID, RegistryKeys.SOUND_EVENT);
  ...
  public static final RegistrySupplier<BulletItem> MEDIUM_CALIBER_BULLET =
      ITEMS.register(
          "medium_caliber_bullet",
          () ->
              new BulletItem(
                  new Item.Settings().arch$tab(ItemGroups.COMBAT),
                  AADataRegistry.MEDIUM_CALIBER_BULLET));

  public static final RegistrySupplier<Item> M1873 =
      ITEMS.register(
          "m1873",
          () ->
  ...
  public static final RegistrySupplier<SoundEvent> RIFLE_SHOT_SOUND =
      registerS("item.gun.rifle.shot");
  public static final RegistrySupplier<SoundEvent> RIFLE_DRY_FIRE_SOUND =
      registerS("item.gun.rifle.dry_fire");
  public static final RegistrySupplier<SoundEvent> RIFLE_LOAD_BULLET_SOUND =
      registerS("item.gun.rifle.load_bullet");
