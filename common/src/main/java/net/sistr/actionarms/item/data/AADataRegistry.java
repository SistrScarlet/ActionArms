...
public class AADataRegistry {
    private static final Map<Class<? extends IData>, Map<String, ? extends IData>> registries = new HashMap<>();

    public static final BulletData MEDIUM_CALIBER_BULLET = new BulletData(
